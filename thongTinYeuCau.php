...
<body>
    <div class="container">
        ...
        $sql = "SELECT * FROM $tablename as db_yeucau, customer as db_kh WHERE db_kh.PhoneNumber = db_yeucau.PhoneNumberCus AND db_kh.CustomerID = ".$_SESSION['currentID']."";
      ...
      <tbody>";
        ...
        if($row['Process'] == 0){
            echo "<td><span class='badge badge-danger'>Chưa hỗ trợ</span></td>";
        }
        else{
            echo "<td><span class='badge badge-success'>Đã hỗ trợ</span></td>";
        } 
        echo "</tr>";
            }
            echo "</tbody>
            ...
            echo "<p>Khách hàng chưa có yêu cầu nào!<p>";
        }
