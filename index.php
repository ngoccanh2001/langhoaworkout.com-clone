...
<body>
    <div class="container">
                    ...
                    if (isset($_SESSION["name"])) {
                        echo "<li class='nav-item dropdown'>
                                ...
                                <div class='dropdown-menu' aria-labelledby='navbarDropdown'>
                                    ...
                                    <a class='dropdown-item' href='dangxuat.php'><i class='fa-solid fa-right-from-bracket'></i> Đăng xuất</a>
                                </div>
                                
                            </li>";
                    } else echo " <li class='nav-item'>
                            <a class='nav-link' href='dangnhap.php'><i class='fas fa-sign-in-alt'></i> Đăng nhập</a>
                          </li>
                          <li class='nav-item'>
                            <a class='nav-link' href='dangky.php'><img src='./img/register.svg' alt='' style='width:16px; height:16.8px;margin-top: -4px;'> Đăng ký</a>
                          </li>";
                    ?>
                    <li class="nav-item">
        ...
        <h2 style="margin-top: 30px; color:#0099ff;">DANH MỤC SẢN PHẨM</h2>
        <div class="row" style="margin-top: 30px; margin-left: 35px; background-color: #f3f7fa;">
            <div class="col">
                <div class="card" style="width: 18rem;">
                    <img src="./img/anh.3-day-chung.png" class="card-img-top" alt="n">
                    <div class="card-body">
                        <h5 class="card-title">Dụng cụ tập luyện</h5>
                        <a href="sanpham.php?id=1" class="btn btn-primary">XEM</a>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card" style="width: 18rem;">
                    <img src="./img/anh.aotanktop.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Quần áo tập luyện</h5>
                        <a href="sanpham.php?id=2" class="btn btn-primary">XEM</a>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card" style="width: 18rem;">
                    <img src="./img/anh.botdaunanh.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Sản phẩm dinh dưỡng</h5>
                        <a href="sanpham.php?id=3" class="btn btn-primary">XEM</a>
                    </div>
                </div>
            </div>
        </div>
